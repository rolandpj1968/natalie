...
Value init_openssl(Env *env, Value self) {
    ...
    Object::define_method(env, Cipher, "initialize"_s, &cipher_lexical_scope, OpenSSL_Cipher_initialize, 1);
    Object::define_method(env, Cipher, "block_size"_s, &cipher_lexical_scope, OpenSSL_Cipher_block_size, 0);
    Object::define_method(env, Cipher, "decrypt"_s, &cipher_lexical_scope, OpenSSL_Cipher_decrypt, 0);
    Object::define_method(env, Cipher, "encrypt"_s, &cipher_lexical_scope, OpenSSL_Cipher_encrypt, 0);
    Object::define_method(env, Cipher, "final"_s, &cipher_lexical_scope, OpenSSL_Cipher_final, 0);
    Object::define_method(env, Cipher, "iv="_s, &cipher_lexical_scope, OpenSSL_Cipher_iv_set, 1);
    Object::define_method(env, Cipher, "iv_len"_s, &cipher_lexical_scope, OpenSSL_Cipher_iv_len, 0);
    Object::define_method(env, Cipher, "key="_s, &cipher_lexical_scope, OpenSSL_Cipher_key_set, 1);
    Object::define_method(env, Cipher, "key_len"_s, &cipher_lexical_scope, OpenSSL_Cipher_key_len, 0);
    Object::define_method(env, Cipher, "update"_s, &cipher_lexical_scope, OpenSSL_Cipher_update, 1);
    Object::define_singleton_method(env, Cipher, "ciphers"_s, &cipher_lexical_scope, OpenSSL_Cipher_ciphers, 0);
    ...
    Object::define_method(env, Digest, "initialize"_s, &digest_lexical_scope, OpenSSL_Digest_initialize, -1);
    Object::define_method(env, Digest, "block_length"_s, &digest_lexical_scope, OpenSSL_Digest_block_length, 0);
    Object::define_method(env, Digest, "digest"_s, &digest_lexical_scope, OpenSSL_Digest_digest, -1);
    Object::define_method(env, Digest, "digest_length"_s, &digest_lexical_scope, OpenSSL_Digest_digest_length, 0);
    Object::define_method(env, Digest, "reset"_s, &digest_lexical_scope, OpenSSL_Digest_reset, 0);
    Object::define_method(env, Digest, "update"_s, &digest_lexical_scope, OpenSSL_Digest_update, 1);
    Object::define_method(env, Digest, "<<"_s, &digest_lexical_scope, OpenSSL_Digest_update, 1);
    ...
    Object::define_singleton_method(env, HMAC, "digest"_s, &hmac_lexical_scope, OpenSSL_HMAC_digest, 3);
    ...
    Object::define_singleton_method(env, KDF, "pbkdf2_hmac"_s, &kdf_lexical_scope, OpenSSL_KDF_pbkdf2_hmac, -1);
    Object::define_singleton_method(env, KDF, "scrypt"_s, &kdf_lexical_scope, OpenSSL_KDF_scrypt, -1);
